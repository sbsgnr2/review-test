...
import { validateSlug } from '@/services/locations/validateSlug';

export default async function validateLocationSlug(request: NextApiRequest, response: NextApiResponse) {
  try {
